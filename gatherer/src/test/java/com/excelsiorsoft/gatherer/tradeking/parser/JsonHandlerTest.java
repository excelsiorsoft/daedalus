...
public class JsonHandlerTest {
	...
	public final static class Quote{
		...
		public static class QuoteBuilder {
			...
			public QuoteBuilder ask(String ask) {
				quote.setBid(Double.parseDouble(ask));
				return this;
			}
		...
		public String toString() {
			return String.format("Quote [bid=%s, ask=%s, symbol=%s]", bid, ask,
					symbol);
		}
	...
	@Test
	public void testJacksonMapping() throws Throwable {
		...
		jsonStr = "{\"response\":{\"@id\":\"2ef96f11:14d8cb4d340:-6433\",\"quotes\":{\"quote\":[{\"ask\":\"3.1500\",\"bid\":\"3.0500\",\"symbol\":\"SLW160115P00021000\"}]}}}";
		...
		try {
			...
			Quote map = mapper.readValue(jsonStr, 
