...
public class ExpirationDatesTest {
	...
	private static ExpirationDatesBuilder expirationBuilder;
	
	@BeforeClass
	public static void setUp(){
		
		expirationBuilder = ExpirationDatesBuilder.builder();
	}
	...
	public void toStringTesting() {
		...
		ExpirationDates expirationDates = expirationBuilder
				.forSymbol("SLW")
