...
import static com.excelsiorsoft.genesis.json.deserialization.DateTimeUtils.fromUnixTimestampToLocalDateTime;
...
import com.excelsiorsoft.daedalus.dominion.impl.ExpirationDates;
 ...
 *
 */
public class ExpirationDateDeserializer implements
		SimpleDeserializer<ExpirationDate> {

	private Logger logger = LoggerFactory
			.getLogger(ExpirationDateDeserializer.class);

	@Override
	public Collection<ExpirationDate> deserialize(JsonNode node)
			throws Throwable {

		List<ExpirationDate> result = new LinkedList<>();
	...
	private ExpirationDate deserializeSingleNode(final JsonNode quote) throws Throwable {
	...
	private Collection<ExpirationDate> deserializeNodeCollection(final JsonNode quotes) throws Throwable {
		
		final List<ExpirationDate> result = new LinkedList<>();
